...
.slide.x:after {
  content: '';
  background-image: url('/tech/mongo.jpg');
  -webkit-transform: translateZ(75px) rotateZ(-90deg);
  transform: translateZ(75px) rotateZ(-90deg);
}

.slide.x:before {
  content: '';
  background-image: url('/tech/vue.png');
  -webkit-transform: translateZ(-75px) rotateZ(-90deg);
  transform: translateZ(-75px) rotateZ(-90deg);
}
...
.slide.y:after {
  content: '';
  background-image: url('/tech/aws.png');
...
.slide.y:before {
  content: '';
  background-image: url('/tech/vuex.png');
...
.slide.z:before {
  content: '';
  background-image: url('/tech/node_m.jpg');
  -webkit-transform: translateZ(-75px);
  transform: translateZ(-75px);
}
...
.shadow {
  ...
  right: 0;
  margin: auto;
  -webkit-animation: rotateShadow 20s infinite cubic-bezier(1, -0.75, 0.5, 1.2);
  animation: rotateShadow 20s infinite cubic-bezier(1, -0.75, 0.5, 1.2);
}
 @-webkit-keyframes 
rotateShadow {  0%, 10% {
-webkit-transform: rotateY(0deg) rotateX(90deg);
